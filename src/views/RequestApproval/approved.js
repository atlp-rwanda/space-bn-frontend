...
const RequestWrapper = () => {
  ...
  // const = <div style={{display: 'flex', flexDirection: 'row'}}>
...
const rows = [
  createData(ids[0], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[0], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[1], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[2], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[3], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[4], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[5], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[6], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
  createData(ids[7], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Approved'),
]
  ...
  return ( 
    <div className={classes2.root}>
      <div className={classes2.wrapper}>
          <Typography variant="h5" className={classes2.title}>Approved Requests </Typography>
