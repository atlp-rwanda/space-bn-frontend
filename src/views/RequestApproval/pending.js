...
const RequestWrapper = () => {
  ...
  const buttons = <div style={{display: 'flex', flexDirection: 'row'}}>
                  <Fab color="primary" aria-label="Done" style={{width: 35,height: 15, marginRight: 10,}} disabled={selected.length > 1}><DoneIcon style={{width: 20, height: 20,}}/></Fab>
                  <IconButton color="secondary" aria-label="reject" style={{width: 40,height: 40,}} disabled={selected.length > 1}><RejectIcon style={{width: 70, height: 43,}}/></IconButton>                 
                </div>;

const rows = [
  createData(ids[0], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[0], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[1], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[2], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[3], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[4], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[5], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[6], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
  createData(ids[7], 'Software Engineer', '2021-02-01','2021-02-01', 'Mariot Hotel', 'VIP', 'Pending',buttons),
]
  ...
  return ( 
    <div className={classes2.root}>
      <div className={classes2.wrapper}>
          <Typography variant="h5" className={classes2.title}>Pending Requests</Typography>
